<template>
  <el-dialog v-model="store.isLoginDialogOpen" width="440" center :show-close="false" class="login-dialog">
    <template #header>
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <span @click="openRegDialog" class="pointer">Создать аккаунт</span>
      </div>
    </template>
  </el-dialog>
</template>
